...
The demo code is in the main.cpp file. I assume there's a given map of 4*4 checkboard, the obstacle lies in the [1,1] point. The output shows the path avoiding the obstacle. Please change the given map to see how the path will change correspondingly.
